...
<div class="w3-main" style="margin-left:300px">
  ...
  <!-- Photo grid -->
    ...
    <div class="w3-half" style="border: 5px solid black; width: 50%; height:750px">
		...
		if ( $act == "call") {
			$cek = mysql_query ("SELECT * FROM tbl_bpjs WHERE status = 2 AND panggil = 2 AND loket = 3 LIMIT 1");
			$pgl = mysql_num_rows ($cek);
			if ($pgl == 0){
				$cek = mysql_query ("SELECT * FROM tbl_bpjs WHERE status = 0 AND panggil = 0 LIMIT 1");
		
				$pgl = mysql_fetch_array ($cek);
				mysql_query("UPDATE tbl_bpjs SET  panggil = 1, loket = 3 WHERE id = $pgl[0]");
				mysql_query("UPDATE tbl_bpjs SET  panggil = 0, loket = 0 WHERE status = 2 AND loket = 3");
				if ($pgl != ''){
					echo"
			...
			$pgl = mysql_fetch_array ($cek);
			mysql_query("UPDATE tbl_bpjs SET  panggil = 0, loket = 0 WHERE status = 2 AND loket = 3");
			mysql_query("UPDATE tbl_bpjs SET  panggil = 0, loket = 0 WHERE status = 0 AND loket = 3");
			mysql_query("UPDATE tbl_bpjs SET  panggil = 2, loket = 3 WHERE id = $pgl[0]");
